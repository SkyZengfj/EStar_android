...
public class NewsHeartDetailConsActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.news_heart_detail_cons);
	...
	private void init() {
		...
		this.runOnUiThread(new Runnable() {
			...
			@Override
			public void run() {
				((TextView) findViewById(R.id.news_heart_detail_cons_title))
						.setText(hhl.title);
				((TextView) findViewById(R.id.news_heart_detail_cons_content))
						.setText(hhl.content);
				...
				Bitmap bmpbig = asyncLoader
						.loadBitmap(
								(ImageView) findViewById(R.id.news_heart_detail_cons_img),
